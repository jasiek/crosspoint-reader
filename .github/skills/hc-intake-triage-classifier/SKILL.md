---
name: hc-intake-triage-classifier
...
mode: subagent
triage_schema_version: v1
metadata:
  owner: holicode
  scope: intake-classification
  origin: workflows/intake-triage.md
  split_companion: hc-intake-triage-sensor
---
